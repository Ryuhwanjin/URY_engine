...
files_map = {
    'URY_Engine_v0.6.9.dmg': 'URY_Engine_v0.6.9.dmg',
    'URY_Engine_v0.6.9_macOS.zip': 'URY_Engine_v0.6.9_macOS.zip',
    'URY_Engine_v0.6.9_Windows.zip': 'URY_Engine_v0.6.9_Windows.zip',
}
...
echo "🎉 URY Engine v0.6.9 배포 폴더 정리 완료!"
echo "   - URY_Engine_v0.6.9.dmg"
echo "   - URY_Engine_v0.6.9_macOS.zip"
echo "   - URY_Engine_v0.6.9_Windows.zip"
echo "======================================================"
