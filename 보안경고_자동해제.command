...
files_map = {
    'URY_Engine_v0.6.4.dmg': 'URY_Engine_v0.6.4.dmg',
    'URY_Engine_v0.6.4_macOS.zip': 'URY_Engine_v0.6.4_macOS.zip',
    'URY_Engine_v0.6.4_Windows.zip': 'URY_Engine_v0.6.4_Windows.zip',
}
...
echo "🎉 URY Engine v0.6.4 배포 폴더 정리 완료!"
echo "   - URY_Engine_v0.6.4.dmg"
echo "   - URY_Engine_v0.6.4_macOS.zip"
echo "   - URY_Engine_v0.6.4_Windows.zip"
echo "======================================================"
