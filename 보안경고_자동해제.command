...
files_map = {
    'URY_Engine_v0.7.6.dmg': 'URY_Engine_v0.7.6.dmg',
    'URY_Engine_v0.7.6_macOS.zip': 'URY_Engine_v0.7.6_macOS.zip',
    'URY_Engine_v0.7.6_Windows.zip': 'URY_Engine_v0.7.6_Windows.zip',
}
...
echo "🎉 URY Engine v0.7.6 배포 폴더 정리 완료!"
echo "   - URY_Engine_v0.7.6.dmg"
echo "   - URY_Engine_v0.7.6_macOS.zip"
echo "   - URY_Engine_v0.7.6_Windows.zip"
echo "======================================================"
