...
files_map = {
    'URY_Engine_v0.7.2.dmg': 'URY_Engine_v0.7.2.dmg',
    'URY_Engine_v0.7.2_macOS.zip': 'URY_Engine_v0.7.2_macOS.zip',
    'URY_Engine_v0.7.2_Windows.zip': 'URY_Engine_v0.7.2_Windows.zip',
}
...
echo "🎉 URY Engine v0.7.2 배포 폴더 정리 완료!"
echo "   - URY_Engine_v0.7.2.dmg"
echo "   - URY_Engine_v0.7.2_macOS.zip"
echo "   - URY_Engine_v0.7.2_Windows.zip"
echo "======================================================"
