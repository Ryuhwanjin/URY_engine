...
files_map = {
    'URY_Engine_v0.6.7.dmg': 'URY_Engine_v0.6.7.dmg',
    'URY_Engine_v0.6.7_macOS.zip': 'URY_Engine_v0.6.7_macOS.zip',
    'URY_Engine_v0.6.7_Windows.zip': 'URY_Engine_v0.6.7_Windows.zip',
}
...
echo "🎉 URY Engine v0.6.7 배포 폴더 정리 완료!"
echo "   - URY_Engine_v0.6.7.dmg"
echo "   - URY_Engine_v0.6.7_macOS.zip"
echo "   - URY_Engine_v0.6.7_Windows.zip"
echo "======================================================"
