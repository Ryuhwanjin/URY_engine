...
files_map = {
    'URY_Engine_v0.7.8.dmg': 'URY_Engine_v0.7.8.dmg',
    'URY_Engine_v0.7.8_macOS.zip': 'URY_Engine_v0.7.8_macOS.zip',
    'URY_Engine_v0.7.8_Windows.zip': 'URY_Engine_v0.7.8_Windows.zip',
}
...
echo "🎉 URY Engine v0.7.8 배포 폴더 정리 완료!"
echo "   - URY_Engine_v0.7.8.dmg"
echo "   - URY_Engine_v0.7.8_macOS.zip"
echo "   - URY_Engine_v0.7.8_Windows.zip"
echo "======================================================"
