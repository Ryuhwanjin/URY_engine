...
files_map = {
    'URY_Engine_v0.7.7.dmg': 'URY_Engine_v0.7.7.dmg',
    'URY_Engine_v0.7.7_macOS.zip': 'URY_Engine_v0.7.7_macOS.zip',
    'URY_Engine_v0.7.7_Windows.zip': 'URY_Engine_v0.7.7_Windows.zip',
}
...
echo "🎉 URY Engine v0.7.7 배포 폴더 정리 완료!"
echo "   - URY_Engine_v0.7.7.dmg"
echo "   - URY_Engine_v0.7.7_macOS.zip"
echo "   - URY_Engine_v0.7.7_Windows.zip"
echo "======================================================"
