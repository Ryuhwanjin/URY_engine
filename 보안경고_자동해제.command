...
files_map = {
    'URY_Engine_v0.7.5.dmg': 'URY_Engine_v0.7.5.dmg',
    'URY_Engine_v0.7.5_macOS.zip': 'URY_Engine_v0.7.5_macOS.zip',
    'URY_Engine_v0.7.5_Windows.zip': 'URY_Engine_v0.7.5_Windows.zip',
}
...
echo "🎉 URY Engine v0.7.5 배포 폴더 정리 완료!"
echo "   - URY_Engine_v0.7.5.dmg"
echo "   - URY_Engine_v0.7.5_macOS.zip"
echo "   - URY_Engine_v0.7.5_Windows.zip"
echo "======================================================"
