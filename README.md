# 🎓 URY Engine v0.7.1 — Academic Note & Exam Studio
...
### 🍏 macOS (맥북 / 맥 스튜디오)
1. **다운로드**: `URY_Engine_v0.7.1.dmg` (또는 `macOS.zip`) 열기 ➔ `URY Engine.app`을 `Applications`(응용 프로그램) 폴더로 드래그
2. **원클릭 실행**: Finder에서 **`01_macOS_실행하기.command`** 더블클릭 *(macOS 보안 격리 자동 해제 후 즉시 구동)*

### 🪟 Windows (윈도우 PC)
1. **압축 해제**: `URY_Engine_v0.7.1_Windows.zip` 압축 해제
...
> 💡 **License & Support**: URY Engine Academic Studio v0.7.1
