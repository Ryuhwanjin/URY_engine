...
# -*- coding: utf-8 -*-
"""
🎓 URY Engine v0.6.7 — macOS & Windows 듀얼 동시 배포 자동화 통합 빌더 (build_release_all.py)
- macOS 패키지 (URY_macOS -> URY_Engine_v0.6.7_macOS.zip & .dmg)
- Windows 패키지 (URY_Windows -> URY_Engine_v0.6.7_Windows.zip)
