...
# -*- coding: utf-8 -*-
"""
🎓 URY Engine — 목표 학점 맞춤형 학습 로드맵 생성 엔진 v0.6.7 (generate_roadmap.py)
...
def generate_course_roadmap(course, target_grade="A+"):
    ...
    md_lines.append(f"> **시스템**: URY Engine (Ultimate Result for You v0.6.7)")
    ...
    md_lines.append("---")
    md_lines.append("`URY Engine v0.6.7 — Powered by Ultimate Result for You`")
