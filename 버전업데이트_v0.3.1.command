#!/bin/bash
# 🎓 URY Engine v0.6.3 - 버전 자동 업그레이드 및 배포 폴더 정리 스크립트

cd "$(dirname "$0")"

echo "========================================================="
echo "🚀 URY Engine v0.6.3 최신 배포 버전 정리 시작"
echo "========================================================="
...
files_map = {
    'URY_Engine_v0.6.3.dmg': 'URY_Engine_v0.6.3.dmg',
    'URY_Engine_v0.6.3_macOS.zip': 'URY_Engine_v0.6.3_macOS.zip',
    'URY_Engine_v0.6.3_Windows.zip': 'URY_Engine_v0.6.3_Windows.zip',
}
...
for old_name, new_name in files_map.items():
    ...
    if os.path.exists(old_p):
        ...
        print(f'  ✅ v0.6.3 릴리즈 생성: {new_name}')
...
print('\n🎉 URY Engine v0.6.3 최신 버전 정리가 완벽히 완료되었습니다!')
"
