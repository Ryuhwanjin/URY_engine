...
# -*- coding: utf-8 -*-
"""
🎓 대학 전공 학업 관리 시스템 — URY Engine v0.6.9 (AI Academic Studio)
- 미니멀 & 직관적인 모던 UI/UX
...
class UnifiedDashboardApp:
    def __init__(self, root):
        self.root = root
        self.root.title("URY Engine — Academic Studio v0.6.9")
...
URY Engine은 사용자의 로컬 컴퓨터 내에서만 독립적으로 동작하며, 어떠한 강의 음성이나 자료도 중앙 서버에 수집·보관하지 않습니다. AI 결과물은 학업 보조용 조교일 뿐 최종 시험 평가 기준을 대체하지 않습니다."""
    ...
    def create_header_card(self):
        ...
        tk.Label(title_row, text=" v0.6.9", font=("Pretendard", 9), bg="#ffffff", fg="#64748b").pack(side=tk.LEFT)
