...
# -*- coding: utf-8 -*-
"""
🎓 URY Engine v0.6.5 - Windows 독립 실행 .EXE 커스텀 경로 자동 설치/빌드 GUI 도구 (build_exe_gui.py)
"""
import os
import sys
import time
...
class ExeBuilderGUI:
    def __init__(self):
        ...
        self.root = tk.Tk()
        self.root.title("URY Engine v0.6.5 — Windows Standalone .EXE Installer/Builder")
        ...
        title_lbl = tk.Label(header_card, text="🚀 URY Engine v0.6.5 - .EXE 커스텀 자동 설치/빌더", font=("Malgun Gothic", 12, "bold"), fg="#ffffff", bg="#1e1e2e")
